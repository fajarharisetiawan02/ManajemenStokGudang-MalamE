...
<head>
    ...
    <title>GudangPro | Tentang Kami</title>
...
<nav class="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-200">
    <div class="container mx-auto px-8 h-20 flex justify-between items-center">
        ...
        <a href="/" class="flex items-center">
            <img src="{{ asset('images/LogoGudangPro.png') }}" class="h-14 brightness-75">
        </a>
        ...
        <div class="hidden md:flex items-center space-x-8 font-medium text-gray-700 ml-auto mr-10">
            ...
            <a href="/about" class="text-blue-700 font-semibold border-b-2 border-blue-700 pb-1">Tentang Kami</a>
            <a href="/contact" class="hover:text-blue-700">Kontak</a>
        </div>

        <a href="/login" class="bg-blue-700 text-white px-5 py-2 rounded-lg shadow hover:bg-blue-800">
            Masuk
        </a>
...
<!-- HERO -->
<section class="bg-gradient-to-br from-slate-100 to-blue-50 py-20 text-center">
...
<!-- ABOUT -->
<section class="container mx-auto px-8 py-20 grid md:grid-cols-2 gap-12 items-center">

    <img src="{{ asset('images/about.png') }}"
         class="rounded-2xl shadow-lg hover:scale-105 transition">

    <div>
        <h2 class="text-2xl font-bold mb-4 text-slate-900">Siapa Kami?</h2>

        <p class="text-gray-600 mb-4">
            <strong>GudangPro</strong> adalah platform digital untuk mengelola stok spare part kendaraan secara real-time.
        </p>

        <p class="text-gray-600 mb-6">
            Mempermudah pencatatan barang masuk & keluar, monitoring stok, serta analisis data.
        </p>

        <div class="flex gap-3 flex-wrap">
            <span class="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg text-sm font-semibold">Mudah Digunakan</span>
            <span class="bg-emerald-100 text-emerald-600 px-4 py-2 rounded-lg text-sm font-semibold">Cepat & Akurat</span>
            <span class="bg-indigo-100 text-indigo-600 px-4 py-2 rounded-lg text-sm font-semibold">Real-Time</span>
        </div>
    </div>
...
<!-- VISI MISI -->
<section class="container mx-auto px-8 pb-24 grid md:grid-cols-2 gap-8">

    <div class="bg-white p-8 rounded-2xl shadow-sm border hover:shadow-xl transition">
        <h3 class="text-xl font-bold text-blue-700 mb-3">🎯 Visi</h3>
        <p class="text-gray-600">
            Menjadi platform manajemen gudang terbaik untuk bisnis modern.
        </p>
    </div>

    <div class="bg-white p-8 rounded-2xl shadow-sm border hover:shadow-xl transition">
        <h3 class="text-xl font-bold text-blue-700 mb-3">🚀 Misi</h3>
        <ul class="text-gray-600 space-y-2">
            <li>• Sistem mudah digunakan</li>
            <li>• Efisiensi operasional</li>
            <li>• Data real-time & akurat</li>
        </ul>
    </div>

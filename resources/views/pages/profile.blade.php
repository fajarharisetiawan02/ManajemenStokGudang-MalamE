...
$colors   = ['from-blue-500 to-blue-600', 'from-purple-500 to-purple-600', 'from-green-500 to-green-600', 'from-rose-500 to-rose-600'];
                    ...
                    <div class="p-6">
                        <div class="grid md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="password_baru_confirmation" id="passwordKonfirm" required

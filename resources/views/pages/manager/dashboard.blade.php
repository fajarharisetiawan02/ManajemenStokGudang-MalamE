...
<div id="dashboardData" class="hidden"
    ...
    data-masuk='@json($chartData["masuk"])'
    data-keluar='@json($chartData["keluar"])'
    data-supplier='@json($distribusiSupplier)'>
</div>

{{-- HERO --}}
<div class="bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl border border-blue-500 shadow-sm mb-8 px-8 py-6 flex items-center justify-between relative overflow-hidden">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-lg transition">
        ...
        <div class="p-6 flex justify-between items-start">
            <div>
                ...
                <span class="inline-flex mt-3 px-3 py-1 rounded-full bg-purple-100 text-purple-600 text-xs font-semibold">
                    Aktif
                </span>
            </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-4 py-4 border text-center">
                        @if($barang->stok <= 0)
                        <span class="inline-flex items-center justify-center min-w-[50px] px-3 py-1 rounded-full bg-red-100 text-red-700 text-xs font-bold">
                            {{ $barang->stok }}
                        </span>
                        @else
                        <span class="inline-flex items-center justify-center min-w-[50px] px-3 py-1 rounded-full bg-yellow-100 text-yellow-700 text-xs font-bold">
                            {{ $barang->stok }}
                        </span>
                        @endif
                    </td>

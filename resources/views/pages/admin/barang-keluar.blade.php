...
<div class="w-full space-y-4">
    ...
    <div class="w-full bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    @forelse($data as $i => $item)
                        <tr class="hover:bg-red-50/40 transition duration-200">
                            ...
                            <td class="px-4 py-4 text-gray-600">{{ $item['tujuan'] }}</td>
                            <td class="px-4 py-4">
                            ...
                            <td colspan="7" class="py-14">
                                <div class="flex flex-col items-center text-center text-gray-500">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">
                                        Silakan input data barang keluar terlebih dahulu.
                                    </p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
            <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600">
                <div class="flex items-center gap-2">
                    <span>Page</span>
                    <button class="w-8 h-8 border border-gray-300 bg-white text-gray-500 hover:bg-gray-100 transition rounded-md">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        window.editData = function (button, index) {
            ...
            document.querySelector('[name="tujuan"]').value = cells[5].innerText.trim();

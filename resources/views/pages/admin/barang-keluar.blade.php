                        ...
                        <div>
                            ...
                            <div class="flex gap-2 mt-2">
                                ...
                                <button type="button" id="cekBarang"
                                    data-cek-url="{{ url('/admin/barang-keluar/cek-barang') }}/"
            ...
            <form method="GET" action="{{ route('admin.barang-keluar.index') }}">
                <div class="px-4 py-4 flex flex-wrap items-center gap-3">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari barang / tujuan..."
                        ...
                        @forelse($barangKeluars as $item)
                            <tr class="hover:bg-slate-50 transition-colors duration-150">
                                <td class="px-4 py-4 border text-center text-black">
                                    {{ $barangKeluars->firstItem() + $loop->index }}</td>
                                ...
                                <td class="px-4 py-4 border text-black max-w-xs break-words">{{ $item->tujuan ?? '-' }}
                                </td>
                            ...
                            <tr>
                                <td colspan="8" class="border">
                                    <div class="flex flex-col items-center justify-center py-10 text-slate-400">
                                        <i class="fas fa-arrow-up text-4xl mb-3 text-slate-300"></i>

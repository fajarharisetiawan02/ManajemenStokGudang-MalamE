...
<div class="w-full space-y-4">
    ...
    <div class="w-full bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-5 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
            <div>
                <h3 id="formTitle" class="text-xl font-semibold text-slate-800">Form Barang Keluar</h3>
        ...
        <form id="mainForm"
            ...
            data-store-url="{{ route('admin.barang-keluar.store') }}"
            method="POST">
            @csrf
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-slate-100 text-slate-800">
                    <tr>
                        ...
                        <th class="px-4 py-4 text-center font-bold border">Jumlah Keluar</th>
                        <th class="px-4 py-4 text-right font-bold border">Harga Jual</th>

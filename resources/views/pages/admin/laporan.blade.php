...
<div class="w-full space-y-5">
    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-5 pt-5 pb-3 flex items-center gap-2">
            <a href="{{ route('admin.laporan.export-excel') }}?dari={{ $dari }}&sampai={{ $sampai }}&jenis={{ $jenis }}"
            ...
            <a href="{{ route('admin.laporan.export-pdf') }}?dari={{ $dari }}&sampai={{ $sampai }}&jenis={{ $jenis }}"
        ...
        {{-- BARIS 2: FILTER --}}
        <form method="GET" action="{{ route('admin.laporan.index') }}" class="px-5 py-4">
